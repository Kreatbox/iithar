    ...
    return Scaffold(
      ...
      bottomNavigationBar: Obx(
        ()=> NavigationBar(
          ...
          destinations: [
            NavigationDestination(icon:Image.asset('assets/icons/icon1.png',height: 30,), label: 'الرئيسية',),
            NavigationDestination(icon:Image.asset('assets/icons/icon3.png',height: 30,), label: 'نشر '),
            NavigationDestination(icon:Image.asset('assets/icons/icon2.png',height: 30,), label: 'الحساب'),
          ],
        ),
      ),
...
class Navigationcontroller extends GetxController {
  ...
  final  screens = [const HomeScreen(),const  PublishReguest(), UserDataScreen( user: FirebaseAuth.instance.currentUser!)
  ];
