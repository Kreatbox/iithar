...
class _SignupScreenState extends State<SignupScreen> {
            ...
            child: Column(
              ...
              children: <Widget>[
                _buildInfoSection('المعلومات الشخصية', [
                  ...
                  Row(
                    children: [
                      Expanded(child:  _buildTextField(_lastNameController, 'اسم العائلة', 'يرجى إدخال اسم عائلتك'), ),
                      const SizedBox(width: 10),
                      Expanded(child:  _buildTextField(_firstNameController, 'الاسم الأول', 'يرجى إدخال اسمك الأول'), ),
                    ],
                  ),
                ...
                ElevatedButton(
                  ...
                  child: const Text('إنشاء حساب',  textAlign: TextAlign.center,
                    style: TextStyle(
  ...
  Widget _buildDropdownFieldGender() {
    return Directionality(
      ...
      dropdownColor: Colors.white,
      alignment: AlignmentDirectional.center,
      style: TextStyle( fontFamily: 'HSI', fontSize: 15, color: Colors.black,
      ),
      ...
      validator: (values) {
        if (values == null || !_genderTypes.contains(FontWeight.values)) {
          return 'يرجى اختيار نوع الجنس ';
        }
        return null;
      },
    ));
